...
<head>
    ...
    <title>GPJEN PROJECT IoT</title>
</head>

<body><br><br><br>
    <div class="container shadow p-3 mb-5 bg-body rounded">
        <div class="card bg-light">
            <div class="card-header"><center><h5>Project IoT ESP8266 - Lampu Otomatis</h5></center></div><br>
            <div class="card-body">
                <?php while ($row = $relay->fetch_assoc()) { ?>
                    ...
                    <?php } ?>
                    <div class='row'>
                        <a href="<?= $url; ?>/index.php?tombol=<?= $row['relay_id'] ?>" class="btn btn-info btn-block btn-success"> <?= $row['nama_relay'] ?> = <?= $logika ?></a>
                    </div>
                    <br>
                <?php } ?>
            </div>
